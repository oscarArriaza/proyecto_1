...
<html lang="en">
    ...
    <?php
        ...
        ?>
                    ...
                    <dialog id="dialogo" modal tabindex="2">
                        <div style="border:solid black;">
                            <div style="border:solid red;">
                                <div style="border:solid green; width: 725px;">
                                    <img src="./media/imagenes/imagenesPersonajePrincipal/retratoLaia.png" id="retratoDeLaia" width="360" height="450">
                                    <img src="./media/imagenes/imagenesPersonajesSecundarios/malikPokot/malikHablando.gif" id="retratoDeMalik" width="360" height="450">

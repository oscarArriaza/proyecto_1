...
<head>
		...
		<title>Mision Cumplida - Energía Baterías</title>
</head>
<body>
<?php
      session_start();
  ...
  ?>
        <div class="BarraInformacion mt-5 d-flex justify-content-around">
			<h2 style="color: rgb(255, 254, 252)">Ya sabes mucho mas sobre <span style="color:#fc8d72">energías</span> renovables</h2>
			...
			<video id="videoPresentacion"  autoplay>
				<source src="assets/media/Energía  Baterías .mp4" type="video/mp4">
			</video>
			...
			<a  id ="BarraInformacion1" href="adios.php" style="text-decoration: none; color: rgb(32, 204, 201);">
				<h2 style="color: rgb(255, 254, 252)">Mision Completada</h2>
			  </a>

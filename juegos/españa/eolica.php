...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  	...
  	<title>Juego Rompecabezas - Energía Eólica -</title>
</head>
<body>
<?php
      session_start();
...
"<img id='" + galeria[i].id + "' class='DragContainer' src='" + galeria[i].src + "' draggable='true' ondragstart='drag(event)' areaDondeSoltar='" + galeria[i].area + "'></img>";
